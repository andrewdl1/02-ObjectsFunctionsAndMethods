...
def main():
    ...
    #even_better_draw_circles(rg.Point(0, 0), 5, 15, 'red', 3)
    #even_better_draw_circles(rg.Point(100, 100), 1, 20, 'blue', 1)
    even_better_draw_circles(rg.Point(200, 200), 2, 10, 'brown', 10)
    even_better_draw_circles(rg.Point(-200, 200), 2, 10, 'red', 10)
    even_better_draw_circles(rg.Point(-200, -200), 2, 10, 'blue', 10)
    even_better_draw_circles(rg.Point(200, -200), 2, 10, 'green', 10)
    even_better_draw_circles(rg.Point(0, 200), 2, 10, 'black', 1)
    even_better_draw_circles(rg.Point(200, -198), 2, 3, 'yellow', 10)
    window.update()
